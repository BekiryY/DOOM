...
set_clock_groups -asynchronous -group [get_clocks {sys_clk}] -group [get_clocks {vga_clk}] -group [get_clocks {ddr_mem_clk}] -group [get_clocks {ddr_user_clk}] -group [get_clocks {hdmi_clk}] -group [get_clocks {tck}]
