module cpu (
    ...
    output reg          icache_fill_en,
    output reg  [31:0]  icache_fill_addr,
    output reg  [127:0] icache_fill_data,
...
// CPU Private (DDR/UART command buses are module outputs)
...
// program_counter and ICache fill lines are module outputs
        ...
        case (state)
            ...
            C_DDR_WAIT_READ: begin
                ...
                if (is_instruction_fetch == 0 && data_addr >= 32'h40000000) begin
                    ...
                    // â”€â”€â”€ 1. Ã–nce ICache'e bak (en hÄ±zlÄ± yol) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
                    if (icache_hit) begin
                        icache_req <= 1;
                        state <= C_ICACHE_WAIT; // 1 saat BSRAM latency
                    end
                    // â”€â”€â”€ 2. Prefetch buffer'da var mÄ±? â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
                    ...
                    // â”€â”€â”€ 3. DDR3'e git â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            ...
            // ========================================================
            // RV32M â€” DIVISION / REMAINDER  (33-cycle iterative)
            // ========================================================
            ...
            C_DIV_SETUP: begin
                ...
                if (read2_data == 32'd0) begin
                    // Division by zero â€” RISC-V spec mandates specific values
                    // DIV/DIVU â†’ 0xFFFFFFFF, REM/REMU â†’ dividend
            ...
            // Restoring divider â€” one bit per clock, 32 clocks total
            ...
            C_DIV_EXEC: begin
                ...
                // (declared as wires above the always block â€” see declarations section)
